...
<body>
	<div class="container d-flex justify-content-between bg-dark bg-opacity-10">
		<h2 class="fs-2 text-light"><c:out value="${user.name}"/>, change your entry</h2>
		<div>
	...
	<div class="container bg-secondary bg-gradient m-2 p-2">
		...
		<form:form action="/books/${book.id}/edit" method="post" modelAttribute="editBook">
			...
			<div class="form-group m-1 fs-5">
                ...
                <form:input type="text" class="form-control mt-2" path="title" value="${book.title}"/>
            </div>
            <div class="form-group m-1 fs-5">
                <form:label class="form-label" path="author">Author:</form:label>
                <form:errors class="text-danger" path="author"/>
                <form:input type="text" class="form-control mt-2" path="author" value="${book.author}"/>
            </div>
            <div class="form-group m-1 fs-5">
            ...
            <input type="submit" class="btn btn-primary m-2 fs-4" value="Edit Book">
		</form:form>
	</div>
	</div>
</body>
